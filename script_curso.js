document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('scroll', function() {
        ...
        tables.forEach(function(table, index) {
            ...
            if (scrollDirection === 'down' && table.classList.contains('hidden') && scrollPosition + windowHeight > tableOffset) {
                table.classList.remove('hidden');
                table.classList.add('visible');
            }

            // Hide tables when scrolling up
            if (scrollDirection === 'up' && !table.classList.contains('hidden') && scrollPosition + windowHeight < tableOffset) {
